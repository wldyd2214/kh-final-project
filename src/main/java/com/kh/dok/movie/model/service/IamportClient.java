...
public class IamportClient {
	...
	public IamportClient() {
		this.api_key = "2239399503487118";
		this.api_secret = "FMENBgmQxHMUFJqH4TxP3JI4eP9cP3AuPeirvEh2m4X1NoJShhHl0ppeezr3C2yshRTMvbPSfMU3aDVs";
	...
	public IamportResponse<Payment> cancelPayment(CancelData cd) throws Exception {
		
		String token = this.getToken();
		
		if(token != null){
			String cancelJsonData = gson.toJson(cd);
